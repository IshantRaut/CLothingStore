...
const CartPage = () => {
	...
	return (
		<div className='py-8 md:py-16 bg-slate-50 min-h-screen'>
...
const EmptyCartUI = () => (
	<motion.div
		className='flex flex-col items-center justify-center space-y-4 py-16 bg-white rounded-xl shadow-md'
		initial={{ opacity: 0, y: 20 }}
		animate={{ opacity: 1, y: 0 }}
		transition={{ duration: 0.5 }}
	>
		<ShoppingCart className='h-24 w-24 text-slate-400' />
		<h3 className='text-2xl font-semibold text-slate-800'>Your cart is empty</h3>
