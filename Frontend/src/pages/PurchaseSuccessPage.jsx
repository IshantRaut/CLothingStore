...
const PurchaseSuccessPage = () => {
	...
	return (
		<div className="h-screen flex items-center justify-center px-4 bg-slate-900">
			<Confetti
			...
			<div className="max-w-md w-full bg-slate-800 rounded-2xl shadow-2xl overflow-hidden relative z-10">
				<div className="p-6 sm:p-8">
					...
					<div className="space-y-4">
						<button
							className="w-full bg-blue-600 hover:bg-blue-500 text-white font-semibold py-2 px-4
						...
						<Link
							to="/"
							className="w-full bg-slate-700 hover:bg-slate-600 text-blue-400 font-semibold py-2 px-4 
							rounded-lg transition duration-300 flex items-center justify-center"
						>
							Continue Shopping
